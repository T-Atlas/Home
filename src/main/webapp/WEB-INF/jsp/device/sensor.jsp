...
<script id="form_html" type="text/html">
    <div class="layui-card-body">
        <form class="layui-form">
            ...
            <%--                    <input type="text" name="temperature" class="layui-input" value="{{ d.temperature }}"--%>
            <%--                           lay-verify="required|number">--%>
            <%--                </div>--%>
            <%--            </div>--%>
            <%--            <div class="layui-form-item">--%>
            <%--                <label class="layui-form-label">Humidity</label>--%>
            <%--                <div class="layui-input-block">--%>
            <%--                    <input type="text" name="humidity" class="layui-input" value="{{ d.humidity }}"--%>
            <%--                           lay-verify="required|number">--%>
            <%--                </div>--%>
            <%--            </div>--%>
            <c:if test="${sysUser.getUtype()==1}">
