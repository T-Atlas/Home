...
<script id="list" type="text/html">
    ...
    <tr data-id="{{ item.deviceid }}" data-typeid="{{ item.typeid }}">
        ...
        <td>
            <i class="bx bx-bulb"
               style="{{ 'color:rgb('+(item.isClose==0?item.r:0)+','+(item.isClose==0?item.g:0)+','+(item.isClose==0?item.b:0)+');font-size:20px;'}}"> </i>
        ...
        <form class="layui-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="number" name="level" class="layui-input" value="{{ d.level }}"
                           lay-verify="required|level">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">R</label>
                <div class="layui-input-block">
                    <input type="number" name="r" class="layui-input" value="{{ d.r }}"
                           lay-verify="required|rgb">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">G</label>
                <div class="layui-input-block">
                    <input type="number" name="g" class="layui-input" value="{{ d.g }}"
                           lay-verify="required|rgb">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="number" name="b" class="layui-input" value="{{ d.b }}"
                           lay-verify="required|rgb">
                </div>
            </div>
            <c:if test="${sysUser.getUtype()==1}">
        ...
        form.verify({
            level: function (value, item) {
                if (value < 0 || value > 100) {
                    return 'Level must be in the range of 0-100';
                }
            },
            rgb: function (value, item) {
                if (value < 0 || value > 255) {
                    return 'RGB value must be in the range of 0-255';
                }
            },
            number: [
                /^([1-9]\d*|[0]{1,1})$/,
