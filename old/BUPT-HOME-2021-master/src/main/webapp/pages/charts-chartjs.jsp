  ...
  <a href="./pages/environmental.jsp">
            ...
            <li>
                <a href="./pages/charts-chartjs.jsp">
                    ...
                    <div class="menu-title">Senser</div>
                </a>
            </li>
        ...
        <div class="page-content-wrapper">
            <div class="page-content">
                ...
                <div class="page-breadcrumb d-none d-md-flex align-items-center mb-3">
                    <div class="breadcrumb-title pr-3">Sensor</div>
                    <div class="pl-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                <li class="breadcrumb-item"><a href=./pages/index.jsp><i class='bx bx-home-alt'></i></a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">Temperature and humidity</li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table mb-0">
                                ...
                                <%--                                    SenserService lightService = new SenserServiceImpl();--%>
                                <%--                                    ArrayList<LightEntity> list = senserService.getExistSenser(userId);--%>
                                ...
                                <%--                                <tr>--%>
                                <%--                                    <th scope="row"> <%= i %> </th>--%>
                                <%--                                    <td> <%= light.getSenserId() %> </td>--%>
                                <%--                                    <td> <%= light.getTemperature() %> </td>--%>
                                <%--                                    <td> <%= light.getHumidity() %> </td>--%>
                                <%--                                </tr>--%>
                                <%--                                    <%--%>
                                <%--                                            i++;--%>
                                <%--                                    }--%>
...
<div class="switcher-wrapper">
    ...
    <div class="switcher-body">
        ...
        <script src="<%=basePath%>assets/plugins/chartjs/js/Chart.min.js"></script>
        <script src="<%=basePath%>assets/plugins/chartjs/js/chartjs-custom.js"></script>
        <!-- App JS -->
