                                    ...
                                    <div class="ml-lg-auto mb-2 mb-lg-0">
                                        <div class="btn-group-round">
                                            <div class="btn-group">
                                                ...
                                                <div class="dropdown-menu"><a class="dropdown-item" href="javaScript:">This
                                                    Week</a>
                ...
                <div class="card-deck flex-column flex-lg-row">
                    <div class="card radius-15">
                        <div class="card-body">
                            ...
                            <div class="media align-items-center">
                                <div>
                                    <img src="${pageContext.request.contextPath }/assets/images/icons/chrome.png"
                            ...
                            <div class="media align-items-center">
                                <div>
                                    <img src="${pageContext.request.contextPath }/assets/images/icons/firefox.png"
                                         width="35" height="35" alt=""/>
                                </div>
                                <div class="media-body ml-3">
                            ...
                            <div class="media align-items-center">
                                <div>
                                    <img src="${pageContext.request.contextPath }/assets/images/icons/edge.png"
                                         width="35" height="35" alt=""/>
                                </div>
                                <div class="media-body ml-3">
                            ...
                            <div class="media align-items-center">
                                <div>
                                    <img src="${pageContext.request.contextPath }/assets/images/icons/opera.png"
                                         width="35" height="35" alt=""/>
                                </div>
                                <div class="media-body ml-3">
                            ...
                            <div class="media align-items-center">
                                <div>
                                    <img src="${pageContext.request.contextPath }/assets/images/icons/safari.png"
                                         width="35" height="35" alt=""/>
                                </div>
                                <div class="media-body ml-3">
                        ...
                        <div class="table-responsive">
                            <table class="table mb-0">
                                ...
                                <tr>
                                    <td>1</td>
                                    <td>
                                        <a href="https://themeforest.net/item/synadmin-bootstrap4-admin-template/29014766"
                                ...
                                <tr>
                                    <td>4</td>
                                    <td>
                                        <a href="https://themeforest.net/item/rukada-responsive-bootstrap-4-admin-template/22820477"
...
<script src="<%=basePath%>assets/plugins/vectormap/jquery-jvectormap-2.0.2.min.js"></script>
<script src="<%=basePath%>assets/plugins/vectormap/jquery-jvectormap-world-mill-en.js"></script>
<script src="<%=basePath%>assets/plugins/vectormap/jquery-jvectormap-in-mill.js"></script>
<script src="<%=basePath%>assets/plugins/vectormap/jquery-jvectormap-us-aea-en.js"></script>
<script src="<%=basePath%>assets/plugins/vectormap/jquery-jvectormap-uk-mill-en.js"></script>
<script src="<%=basePath%>assets/plugins/vectormap/jquery-jvectormap-au-mill.js"></script>
