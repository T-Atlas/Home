                                        ...
                                        <div class="card radius-15">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <h2 class="mb-0 text-white"><%= username %><i
                                    ...
                                    <div class="col-12 col-lg-4">
                                        <div class="card radius-15">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <h2 class="mb-0 text-white"><%= userEmail %><i
                                                                class=' font-14 text-white'></i></h2>
                                                    </div>
                                    ...
                                    <div class="col-12 col-lg-4">
                                        <div class="card radius-15">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <h2 class="mb-0 text-white"><%= userTel %><i
                                                                class=' font-14 text-white'></i></h2>
                                                    </div>
                                                    <div class="ml-auto font-35 text-white"><i
                                    ...
                                    <div class="col-12 col-lg-4">
                                        <div class="card radius-15">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <h2 class="mb-0 text-white"><%= userRoomId %><i
                                                                class=' font-14 text-white'></i></h2>
                                                    </div>
                                    ...
                                    <div class="col-12 col-lg-4">
                                        <div class="card radius-15">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <h2 class="mb-0 text-white"><%= userAge %><i
                                                                class=' font-14 text-white'></i></h2>
                                                    </div>
